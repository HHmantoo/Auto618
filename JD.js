...
let showVersion = function () {
    ...
    console.log('https://github.com/asd920/Auto618')
    toast('当前版本：' + VERSION)
}
...
function openAndInto() {
    ...
    app.startActivity({
        action: "VIEW",
        data: 'openApp.jdMobile://virtual?params={"category":"jump","action":"to","des":"m","sourceValue":"JSHOP_SOURCE_VALUE","sourceType":"JSHOP_SOURCE_TYPE","url":"https://pro.m.jd.com/mall/active/3uT8xr7BvwiWmif5m2h9j1zeKgBG/index.html?babelChannel=ttt14&jwebprog=0&hybrid_err_view=1&transparent=1&commontitle=no","M_sourceFrom":"mxz","msf_type":"auto"}'
    })
}
